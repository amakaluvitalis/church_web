            ...
            <div class="max-w-4xl mx-auto bg-white rounded-lg p-8 shadow-lg">
                ...
                <div class="flex flex-col md:flex-row items-center md:items-start space-y-6 md:space-y-0 md:space-x-8">
                    ...
                    <div class="flex-shrink-0">
                        <img src="public/images/vicar_placeholder.jpg" alt="Rev. Emmah Omondi - Vicar" 
                    ...
                    <div class="text-center md:text-left">
                        <h3 class="text-3xl font-semibold text-[#660000] mb-4">
                            Message From The Vicar - Rev. Emmah Omondi
                        </h3>
                        <p class="text-lg text-gray-600 mb-4">
                            “Please allow me to cordially welcome you to the ACK ALL SAINTS MASENO PARISH, in the Diocese of Maseno South.
                            We are a one-Church parish located along the Kisumu - Busia Road at Maseno Municipality, in the neighborhood of 
                            Maseno University and adjacent to Maseno School for Hearing Impaired.
                        </p>
                        <p class="text-lg text-gray-600 mb-4">
                            We are committed to following Jesus and joyously worshiping Him. Our Theme for 2025 is from John 4:29: 
                            ‘Come, see a man…’
                        </p>
                        <p class="text-lg text-gray-600">
                            As a church family, we seek to be an exemplary congregation bound together by the love of Christ, reaching 
                            and touching lives by word and deed. Feel free to worship with us and participate in our activities.”
                        </p>
                    </div>
    ...
    <section class="py-16">
        <div class="container mx-auto px-4 md:px-12 text-center">
            ...
            <div class="bg-white shadow-lg rounded-lg p-6 md:p-8 max-w-2xl mx-auto">
                ...
                <!-- Membership Form -->
                <form action="process-membership.php" method="POST" class="bg-white">
                    <div class="space-y-4">
                        <!-- Full Name -->
