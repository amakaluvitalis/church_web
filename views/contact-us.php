...
<main class="flex-grow bg-white py-12 px-4 text-center mt-20">
    ...
    <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 text-left">
        ...
        <div class="overflow-hidden rounded-lg shadow-lg">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1680.5017654517949!2d34.59835521404475!3d-0.0062290125386999925!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x182aa9f852d5b733%3A0x905e256cd388896!2sMaseno%20ACK%20Church!5e1!3m2!1sen!2ske!4v1740627894840!5m2!1sen!2ske"
            ...
            <form action="process-contact.php" method="POST">
                <div class="space-y-4">
                    ...
                    <div class="flex flex-col">
                        <label for="name" class="text-gray-800 font-semibold">Full Name <span class="text-red-500">*</span></label>
                        <input type="text" id="name" name="name"
                            class="p-3 border border-[#660000] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#660000]"
                            placeholder="Enter your full name" required>
                    </div>

                    <!-- Email -->
                    <div class="flex flex-col">
                        <label for="email" class="text-gray-800 font-semibold">Email <span class="text-red-500">*</span></label>
                    ...
                    <!-- Message -->
                    <div class="flex flex-col">
                        <label for="message" class="text-gray-800 font-semibold">Message <span class="text-red-500">*</span></label>
