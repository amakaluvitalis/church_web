<aside class="w-64 bg-[#660000] text-white h-screen flex flex-col py-6 px-4 shadow-lg">
    ...
    <div class="flex items-center space-x-3 justify-center mb-6">
        <img src="../../images/ack_logo.png" alt="Church Logo" class="h-12 w-auto">
    ...
    <nav class="flex-grow">
        <ul class="space-y-2">
            <li>
                ...
                <img src="../../images/dashboard.svg" alt="Logout" class="w-6 h-6">
                    <span>Dashboard</span>
                </a>
            </li>
            <li>
                ...
                <img src="../../images/manage.svg" alt="Logout" class="w-6 h-6">
            ...
            <li>
                ...
                <img src="../../images/analyse.svg" alt="Logout" class="w-6 h-6">
    ...
    <!-- Logout Button -->
    <a href="logout.php" class="flex items-center justify-center space-x-3 p-3 rounded-lg bg-red-500 hover:bg-red-600 transition-all duration-200 ease-in-out">
        <img src="../../images/bx-log-out.svg" alt="Logout" class="w-6 h-6">
        <span>Logout</span>
    </a>
</aside>
